...
url <- "https://pl.wikipedia.org/wiki/Pos%C5%82owie_na_Sejm_Rzeczypospolitej_Polskiej_III_kadencji"
...
df <- data.frame(kadencja="III",etap="start",lista, klub="", stringsAsFactors = FALSE)
...
write.csv(przypisy, "przypisy_3K.csv")
przypisy <- read.csv("przypisy_3K.csv", sep=",")
