...
url <- "https://pl.wikipedia.org/wiki/Pos%C5%82owie_na_Sejm_Rzeczypospolitej_Polskiej_VI_kadencji"
...
df <- data.frame(kadencja="VI",etap="start",lista, klub="", stringsAsFactors = FALSE)
...
write.csv(przypisy, "przypisy_6K.csv")
przypisy <- read.csv("przypisy_6K.csv", sep=",")
