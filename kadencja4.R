...
url <- "https://pl.wikipedia.org/wiki/Pos%C5%82owie_na_Sejm_Rzeczypospolitej_Polskiej_IV_kadencji"
...
df <- data.frame(kadencja="IV",etap="start",lista, klub="", stringsAsFactors = FALSE)
...
write.csv(przypisy, "przypisy_4K.csv")
przypisy <- read.csv("przypisy_4K.csv", sep=",")
